...
def add_default_eoc_set():
    ...
    if created:
                ...
                "eocSpecifics": [
                    {
                        ...
                        "indicatorsOfAttainment": [
                            "Engages with the engineering discipline at a phenomenological level, applying sciences and engineering fundamentals to systematic investigation, interpretation, analysis and innovative solution of complex problems and broader aspects of engineering practice."
                        ],
                    },
                    {
                        "eocSpecific": 2,
                    ...
                    },
                    {
                        ...
                        "indicatorsOfAttainment": [
                            "Identifies and critically appraises current developments, advanced technologies, emerging issues and interdisciplinary linkages in at least one specialist practice domain of the engineering discipline.",
                    ...
                    {
                        "eocSpecific": 6,
                        "description": "Understanding of the scope, principles, norms, accountabilities and bounds of sustainable engineering practice in the specific discipline.",
                        "indicatorsOfAttainment": [
            ...
            },
            {
                ...
                "eocSpecifics": [
                    ...
                    },
                    {
                        ...
                        "indicatorsOfAttainment": [
                            "Proficiently applies technical knowledge and open ended problem solving skills as well as appropriate tools and resources to design components, elements, systems, plant, facilities and/or processes to satisfy user requirements.",
            ...
            },
            {
                ...
                "eocSpecifics": [
                    ...
                    },
                    {
                        ...
                        "indicatorsOfAttainment": [
                            "Is proficient in locating and utilising information -including accessing, systematically searching, analysing, evaluating and referencing relevant published works and data; is proficient in the use of indexes, bibliographic databases and other search facilities.",
        ...
        for eocGeneral in BASE_EOC:
            eocGeneral_obj = EOCGeneral.objects.create(number=eocGeneral["eocGeneral"], title=eocGeneral["title"], eoc_set=base_eoc_set)
