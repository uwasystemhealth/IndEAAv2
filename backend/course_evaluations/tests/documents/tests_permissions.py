...
def test_list_view_course_evaluation_documents_anonymous(api_client_no_auth, make_course_evaluation):
    """
...
@pytest.mark.django_db
def test_create_view_course_evaluation_documents_anonymous(api_client_no_auth, make_course_evaluation):
    """
    GIVEN: The user is not authenticated
    WHEN: I create a course evaluation document
    THEN:  The user is not authorised to use the endpoint
    """
    course_evaluation = make_course_evaluation(coordinators=[])
    url = reverse(
...
@pytest.mark.django_db
def test_update_view_course_evaluation_documents_anonymous(api_client_no_auth, make_course_evaluation_document, make_course_evaluation):
    """
    GIVEN: The user is not authenticated
    WHEN: I update a course evaluation document
    THEN: The user is not authorised to use the endpoint
    """
...
@pytest.mark.django_db
def test_delete_view_course_evaluation_documents_anonymous(api_client_no_auth, make_course_evaluation_document, make_course_evaluation):
    """
    GIVEN: The user is not authenticated
    WHEN: I delete a course evaluation document
    THEN: The user is not authorised to use the endpoint
    """
    course_evaluation = make_course_evaluation()
...
@pytest.mark.django_db
def test_create_view_course_evaluation_documents_reviewer(api_client_with_credentials_return_user, make_course_evaluation, make_course_review):
    """
